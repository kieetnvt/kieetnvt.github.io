...
subtitle: React development has usually started with Create React App (CRA), but nowadays
  Vite is better in many aspects, as this article shows.
...
author: kieetnvt
lang: vi
ref: choose-vite-over-create-react-app
---
